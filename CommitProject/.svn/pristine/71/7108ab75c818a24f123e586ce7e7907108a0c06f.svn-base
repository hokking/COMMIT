...
<div class="side-menu-button">
  ...
  <div class="side-menu-bar">
   ...
   <img style='cursor:pointer' id="logoimg" alt="로고.png" src="<%=request.getContextPath() %>/images/심플로고1.PNG">
	...
	IApplyResumeService service2 = ApplyResumeServiceImpl.getInstance();
	List<RecruitVO> list = service2.selectRecruit(memid);
	...
	<div id="my">
  	...
  	<div class="box">
  	 <img class="profile" src="<%=request.getContextPath() %>/images/옹기.jpg">
          ...
          <button onclick="location.href='<%=request.getContextPath() %>/mypage/recruitMyAll.jsp'" style='cursor:pointer' class="bmain" id="resume" type="button" value="채용공고">
          	채용공고<br>(<%=list.size()%>)
          </button>

          <button onclick="location.href='<%=request.getContextPath() %>/mypage/recruitapplylist.jsp'" style='cursor:pointer' class="bmain" id="apply" type="button" value="지원현황">지원현황<br></button>
