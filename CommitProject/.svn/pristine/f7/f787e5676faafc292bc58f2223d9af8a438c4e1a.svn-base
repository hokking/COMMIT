...
%>
         ...
         <div class="dropdown" style="float: right;">
			...
			<ul class="dropdown-menu" role="menu" aria-labelledby="menu1" id="aa">
                <li><input role="menuitem" tabindex="-1" type="radio" id="pop" name="a" value="인기순" checked="checked"> 인기순</li>
                <li><input role="menuitem" tabindex="-1" type="radio" id="new" name="a" value="최신순"> 최신순</li>
			</ul>
		</div>
	</div>
