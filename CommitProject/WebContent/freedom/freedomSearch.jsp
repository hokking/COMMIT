...
%>
<br>
<div><h4><strong><%=search_text%></strong>(으)로 검색한 게시글입니다.</h4></div>
<br>
<div>
...
<%
	IFreedomService service3 = FreedomServiceImpl.getService();

	List<FreedomVO> list3 = null;
	
	if(search_select.equals("1")){
		list3 = service3.searchTitleFreeBoard(search_text);  
		
	}else {  
		list3 = service3.searchMemIdFreeBoard(search_text);
	}
...
<script type="text/javascript">listPage(currentPage);</script>
