...
<section>
	...
	List<RecruitVO> list = service.selectRecruit(memid);
	%> 
	...
	<div id="title">
		 <a href="<%=request.getContextPath() %>/mypage/recruitMyDetail.jsp?recruit_num=<%=vo.getRecruit_num() %>"><%= vo.getRecruit_name() %>
		 </a>
	</div>
	<br>
