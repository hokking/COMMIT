...
<div class="side-menu-button">
  ...
  <div class="side-menu-bar">
   ...
   <img style='cursor:pointer' id="logoimg" alt="로고.png" src="<%=request.getContextPath() %>/images/심플로고1.PNG">
	...
	int rs = service.selectresume(memid);
	...
	List<RecruitVO> list = service1.selectApply(memid);

	IFavoriteService fservice = FavoriteServiceImpl.getInstance();
	int rs2= fservice.favoriteTF2(memid);
	%> 
   <div id="sbar1">
	...
	<div id="my">
  	...
  	<div class="box">
  	 <img class="profile" src="<%=request.getContextPath() %>/images/옹기.jpg">
          ...
          <button onclick="location.href='<%=request.getContextPath() %>/mypage/resume.jsp'" style='cursor:pointer' class="bmain" id="resume" type="button" value="이력서">
          	이력서<br>(<%=rs %>)
          </button>

          <button onclick="location.href='<%=request.getContextPath() %>/mypage/statusApply.jsp'" style='cursor:pointer' class="bmain" id="apply" type="button" value="지원현황">지원현황<br>(<%=list.size() %>)</button>
          <button onclick="location.href='<%=request.getContextPath() %>/favorite/favoritemain.jsp'" style='cursor:pointer' class="bmain" id="company" type="button" value="관심공고">관심공고<br>(<%=rs2 %>)</button>
          <button onclick="location.href='<%=request.getContextPath() %>/mypage/info.jsp'" style='cursor:pointer' class="bmain" id="info"type="button" value="개인정보관리">개인정보<br>관리 </button>
          <button onclick="location.href='<%=request.getContextPath() %>/qna/qnamain.jsp'" style='cursor:pointer' class="bmain" id="info"type="button" value="qna">1:1<br>문의 </button>
		</div>
