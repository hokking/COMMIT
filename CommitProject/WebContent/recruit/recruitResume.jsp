...
<section>
	...
	List<ResumeVO> list = service.listresume(memid);
	%> 
	...
	<button id="bresume" style='cursor:pointer' onclick="location.href='<%=request.getContextPath() %>/mypage/resumeWrite.jsp'" type="button" >
	이력서 등록하기</button>
	...
	<div id="title">
		 <a href="<%=request.getContextPath() %>/applyResume.do?resumeNum=<%=vo.getResume_num() %>&recruitNum=<%=recruitNum %>" onclick="return confirm('해당 이력서를 제출하시겠습니까?');"><%=vo.getResume_title()%>
		 </a>
	</div>
	<br>
