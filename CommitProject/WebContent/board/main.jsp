...
<header>
   ...
   <img style='cursor:pointer' id="logoimg" alt="로고.png" src="./images/심플로고1.PNG">
      ...
      <button style='cursor:pointer' onclick="alert('로그인을 해주세요')" type="button" class="nt">커뮤니티</button>
    </div>
...
<aside>
   ...
   <input onClick="location.href='<%=request.getContextPath()%>/board/login.jsp'" style='cursor:pointer' id="joinbutton" type="button" value="회원가입 / 로그인"> 
   <br>
   <div id="notice">
